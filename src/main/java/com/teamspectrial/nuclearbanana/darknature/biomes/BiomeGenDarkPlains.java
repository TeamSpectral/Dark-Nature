package com.teamspectrial.nuclearbanana.darknature.biomes;
...
public class BiomeGenDarkPlains extends BiomeGenBase
{
    protected boolean field_150628_aC;

    public BiomeGenDarkPlains(int p_i1986_1_)
    {
        super(p_i1986_1_);
        
        this.setTemperatureRainfall(0.8F, 0.4F);
        this.topBlock = DarkNatureCore.DarkGrass;
        this.fillerBlock = DarkNatureCore.DarkDirt;
        
        this.waterColorMultiplier = 0x54305B;
