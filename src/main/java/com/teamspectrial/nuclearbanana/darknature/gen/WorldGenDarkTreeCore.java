...
public abstract class WorldGenDarkTreeCore extends WorldGenerator
{
    ...
    public WorldGenDarkTreeCore(boolean p_i45448_1_)
    {
        super(p_i45448_1_);
    }
    ...
    {
        return p_150523_1_.getMaterial() == Material.air || p_150523_1_.getMaterial() == Material.leaves || p_150523_1_ == Blocks.sapling || p_150523_1_ == Blocks.vine;
    }
